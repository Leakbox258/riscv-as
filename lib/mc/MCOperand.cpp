...
const StringMap<uint8_t> Registers = {
...
const StringMap<uint8_t> CRegisters = {
...
MCOperand MCOperand::makeImm(int64_t _Imm) {
  MCOperand op;
...
MCOperand MCOperand::makeSFPImm(uint32_t _SFPImm) {
  MCOperand op;
...
MCOperand MCOperand::makeDFPImm(uint64_t _DFPImm) {
  MCOperand op;
...
MCOperand MCOperand::makeExpr(MCExpr* _Expr) {
  MCOperand op;
...
MCOperand MCOperand::makeInst(const MCInst* _Inst) {
  MCOperand op;
